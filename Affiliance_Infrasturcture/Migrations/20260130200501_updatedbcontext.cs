        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CanManageCampaigns = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommercialRegister = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SkillsExtracted = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PersonalityScore = table.Column<int>(type: "int", nullable: true),
                    PersonalityTestTaken = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommissionValue = table.Column<decimal>(type: "decimal(10,2)", precision: 18, scale: 2, nullable: false),
                    Budget = table.Column<decimal>(type: "decimal(12,2)", precision: 18, scale: 2, nullable: true),
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    PromotionalMaterials = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TrackingBaseUrl = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Campaigns_Admins_AdminId",
                        column: x => x.AdminId,
                        principalTable: "Admins",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Campaigns_AspNetUsers_ApprovedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Type = table.Column<int>(type: "int", nullable: false),
                    Score = table.Column<decimal>(type: "decimal(5,3)", precision: 5, scale: 3, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AiSuggestions_Campaigns_CampaignId",
                        column: x => x.CampaignId,
                        principalTable: "Campaigns",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AiSuggestions_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AiSuggestions_Marketers_MarketerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    AiMatchScore = table.Column<decimal>(type: "decimal(5,3)", precision: 5, scale: 3, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CampaignApplications_Marketers_MarketerId",
                        column: x => x.MarketerId,
                        principalTable: "Marketers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Complaints_AspNetUsers_DefendantId",
                        column: x => x.DefendantId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Complaints_AspNetUsers_ResolvedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CampaignId = table.Column<int>(type: "int", nullable: false),
                    MarketerId = table.Column<int>(type: "int", nullable: false),
                    UniqueLink = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    Clicks = table.Column<int>(type: "int", nullable: false),
                    Conversions = table.Column<int>(type: "int", nullable: false),
                    Earnings = table.Column<decimal>(type: "decimal(12,2)", precision: 18, scale: 2, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TrackingLinks_Campaigns_CampaignId",
                        column: x => x.CampaignId,
                        principalTable: "Campaigns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TrackingLinks_Marketers_MarketerId",
                        column: x => x.MarketerId,
                        principalTable: "Marketers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AmountEarned = table.Column<decimal>(type: "decimal(10,2)", precision: 18, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PerformanceLogs_TrackingLinks_TrackingLinkId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AiSuggestions_CampaignId",
                table: "AiSuggestions",
                column: "CampaignId");

            migrationBuilder.CreateIndex(
                name: "IX_AiSuggestions_CompanyId",
                table: "AiSuggestions",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_AiSuggestions_MarketerId",
                table: "AiSuggestions",
                column: "MarketerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CampaignApplications_MarketerId",
                table: "CampaignApplications",
                column: "MarketerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PerformanceLogs_TrackingLinkId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrackingLinks_CampaignId",
                table: "TrackingLinks",
                column: "CampaignId");

            migrationBuilder.CreateIndex(
                name: "IX_TrackingLinks_MarketerId",
                table: "TrackingLinks",
                column: "MarketerId");

            migrationBuilder.CreateIndex(
                name: "IX_TrackingLinks_UniqueLink",
                table: "TrackingLinks",
                column: "UniqueLink",
                unique: true);
        }
